...
models <- readRDS("supplemantary_models.rds")
anovas <- readRDS("supplemantary_anovas.rds")
...
p_Places_LSD = plot_model(models$Places_LSD,type="est",
                          ...
                          group.terms = c(1,1,1,2,2,2,3,3,4,4,4,5,5,5,6),
                          vline.color = "#C0C0C0",
...
p_Places_MSH = plot_model(models$Places_Mushrooms,type="est",
                          ...
                          group.terms = c(1,1,1,2,2,2,3,4,4,5,5,5,6),
                          vline.color = "#C0C0C0",
...
p_People_LSD = plot_model(models$WithWhom_LSD,type="est",
                          ...
                          group.terms = c(1,1,1,2,2,2,3,3,3,4,4,4,5,6),
                          vline.color = "#C0C0C0",
...
p_People_MSH = plot_model(models$WithWhom_Mushrooms,type="est",
                          ...
                          group.terms = c(1,1,1,2,2,2,3,3,3,4,4,4,5),
                          vline.color = "#C0C0C0",
